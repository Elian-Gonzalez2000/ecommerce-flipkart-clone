...
import SuccessCheckout from "./containers/CheckoutPage/Success";
import CancelCheckout from "./containers/CheckoutPage/Cancel";
    ...
    <div className="App">
      <Router>
        <Routes>
          ...
          <Route path="/checkout/success" exact element={<SuccessCheckout />} />
          <Route
